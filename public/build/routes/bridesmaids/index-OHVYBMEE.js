...
function Bridesmaids() {
  return /* @__PURE__ */ React.createElement("div", {
    className: "lg:px-20 lg:pt-20 sm:px-4"
    ...
    className: "text-4xl sm:my-6 md:my-10 font-display"
  }, "Hey,"), /* @__PURE__ */ React.createElement("p", {
    className: "lg:text-base text-sm mb-6 font-body max-w-sm"
...
//# sourceMappingURL=/build/routes/bridesmaids/index-OHVYBMEE.js.map
