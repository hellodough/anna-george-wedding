...
function Index() {
  ...
  return /* @__PURE__ */ React.createElement("div", {
    ...
    className: "bg-hero-image w-screen h-screen bg-no-repeat text-white bg-cover bg-center flex flex-col justify-items-start"
    ...
    className: " flex items-center flex-col text-center justify-self-center"
...
//# sourceMappingURL=/build/routes/index-ZEXV53QF.js.map
