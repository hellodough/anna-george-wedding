...
var DisclosureContext = /* @__PURE__ */ (0, import_react9.createContext)(null);
DisclosureContext.displayName = "DisclosureContext";
function useDisclosureContext(component) {
  var context = (0, import_react9.useContext)(DisclosureContext);
  if (context === null) {
...
var DisclosureAPIContext = /* @__PURE__ */ (0, import_react9.createContext)(null);
DisclosureAPIContext.displayName = "DisclosureAPIContext";
function useDisclosureAPIContext(component) {
  var context = (0, import_react9.useContext)(DisclosureAPIContext);
  if (context === null) {
    var err = new Error("<" + component + " /> is missing a parent <" + Disclosure.name + " /> component.");
    if (Error.captureStackTrace)
...
var DisclosurePanelContext = /* @__PURE__ */ (0, import_react9.createContext)(null);
DisclosurePanelContext.displayName = "DisclosurePanelContext";
function useDisclosurePanelContext() {
  return (0, import_react9.useContext)(DisclosurePanelContext);
}
function stateReducer(state2, action) {
  return match(action.type, reducers, state2, action);
}
var DEFAULT_DISCLOSURE_TAG = import_react9.Fragment;
function Disclosure(props) {
  ...
  var reducerBag = (0, import_react9.useReducer)(stateReducer, {
  ...
  var close = (0, import_react9.useCallback)(function(focusableElement) {
    dispatch({
  ...
  var api = (0, import_react9.useMemo)(function() {
    return {
      close
    };
  }, [close]);
  var slot = (0, import_react9.useMemo)(function() {
    return {
      open: disclosureState === DisclosureStates.Open,
      close
    };
  }, [disclosureState, close]);
  return import_react9.default.createElement(DisclosureContext.Provider, {
    value: reducerBag
  }, import_react9.default.createElement(DisclosureAPIContext.Provider, {
    value: api
  }, import_react9.default.createElement(OpenClosedProvider, {
...
var Button = /* @__PURE__ */ forwardRefWithAs(function Button2(props, ref) {
  ...
  var internalButtonRef = (0, import_react9.useRef)(null);
  ...
  var handleKeyUp = (0, import_react9.useCallback)(function(event) {
    switch (event.key) {
      case Keys.Space:
        event.preventDefault();
        break;
  ...
  var handleClick = (0, import_react9.useCallback)(function(event) {
...
var Panel = /* @__PURE__ */ forwardRefWithAs(function Panel2(props, ref) {
  ...
  var passthroughProps = props;
  return import_react9.default.createElement(DisclosurePanelContext.Provider, {
...
function useDisposables() {
  var _useState = (0, import_react10.useState)(disposables), d = _useState[0];
...
function useTreeWalker(_ref) {
  ...
  var acceptRef = (0, import_react11.useRef)(accept);
  var walkRef = (0, import_react11.useRef)(walk);
...
var MenuContext = /* @__PURE__ */ (0, import_react12.createContext)(null);
MenuContext.displayName = "MenuContext";
function useMenuContext(component) {
  var context = (0, import_react12.useContext)(MenuContext);
  if (context === null) {
...
var DEFAULT_MENU_TAG = import_react12.Fragment;
function Menu(props) {
  var _match;
  var reducerBag = (0, import_react12.useReducer)(stateReducer2, {
    menuState: MenuStates.Closed,
    buttonRef: (0, import_react12.createRef)(),
    itemsRef: (0, import_react12.createRef)(),
    items: [],
    searchQuery: "",
    activeItemIndex: null
  });
  ...
  var slot = (0, import_react12.useMemo)(function() {
    return {
      open: menuState === MenuStates.Open
    };
  }, [menuState]);
  return import_react12.default.createElement(MenuContext.Provider, {
    value: reducerBag
  }, import_react12.default.createElement(OpenClosedProvider, {
...
var Button3 = /* @__PURE__ */ forwardRefWithAs(function Button4(props, ref) {
  ...
  var handleKeyUp = (0, import_react12.useCallback)(function(event) {
    switch (event.key) {
      case Keys.Space:
        event.preventDefault();
        break;
  ...
  var handleClick = (0, import_react12.useCallback)(function(event) {
    if (isDisabledReactIssue7711(event.currentTarget))
...
var DEFAULT_ITEM_TAG = import_react12.Fragment;
function Item(props) {
  ...
  var bag = (0, import_react12.useRef)({
    disabled
  });
  useIsoMorphicEffect(function() {
  ...
  var handleFocus = (0, import_react12.useCallback)(function() {
    if (disabled)
      return dispatch({
        type: ActionTypes2.GoToItem,
  ...
  var handleMove = (0, import_react12.useCallback)(function() {
    if (disabled)
      return;
    if (active)
      return;
  ...
  var handleLeave = (0, import_react12.useCallback)(function() {
    if (disabled)
      return;
    if (!active)
      return;
...
//# sourceMappingURL=/build/root-V6NHA6GX.js.map
