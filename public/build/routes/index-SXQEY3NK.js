...
function Index() {
  ...
  return /* @__PURE__ */ React.createElement("div", {
    ...
    className: "bg-hero-image w-screen h-screen bg-no-repeat text-white bg-cover bg-center flex flex-col items-start"
    ...
    className: " flex items-center flex-col text-center self-center"
...
//# sourceMappingURL=/build/routes/index-SXQEY3NK.js.map
