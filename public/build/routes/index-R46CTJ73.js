...
function Index() {
  ...
  return /* @__PURE__ */ React.createElement("div", {
    ...
    className: "bg-hero-image w-screen h-screen bg-no-repeat text-white bg-cover bg-center grid grid-rows-4"
    ...
    className: "row-span-3 flex flex-col text-center"
    ...
    className: "text-display text-8xl"
  }, "Anna & George")), /* @__PURE__ */ React.createElement("div", {
    className: "text-2xl"
  }, /* @__PURE__ */ React.createElement("p", null, "Saturday"), /* @__PURE__ */ React.createElement("p", null, "07 - 16 - 22"), /* @__PURE__ */ React.createElement("p", null, "Chicago")))));
}
export {
  Index as default,
  meta
};
//# sourceMappingURL=/build/routes/index-R46CTJ73.js.map
