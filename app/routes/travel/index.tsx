    ...
    <div>
      ...
      <div className="sm:pt-24 pt-12 text-center font-body">
        ...
        <div className="mx-4">
          ...
          <p>
            {" "}
            all you have to do is mention the <strong>Do wedding block</strong>
          </p>
          <p>when booking over the phone to get discounted rates</p>
          starting at <strong>$129</strong> + taxes
          <p>
            If you prefer <strong>booking online</strong>, you can fill out this form instead:
          </p>
          <a
        ...
        <div className="mt-4">
          ...
          <p className="py-1">
            ...
            <a href="https://forms.gle/y3V1CyberMCCAtaa7" className="hover:bg-blue-800 hover:text-white underline decoration-slate-700 decoration-2 text-blue-700">Book online</a>
            {" "}
            <span className="mx-4">|</span>
            <a
              href="tel:7862755414"
